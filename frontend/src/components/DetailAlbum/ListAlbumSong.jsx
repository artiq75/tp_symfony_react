            ...
            <table className="min-w-full text-left text-sm font-light">
              ...
              <tbody>
                {songs ? (
                  songs.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="flex items-center gap-x-1 whitespace-nowrap px-6 py-4 font-medium m-1">
                          <span>{duration}</span>
                          {isHover === index && <AddToPlaylist song={row} />}
                        </td>
                      </tr>
                    )
                  })
                  ...
                  <tr>
                    <td>pas de titre pour cet album</td>
                  </tr>
                )}
              </tbody>
            </table>
